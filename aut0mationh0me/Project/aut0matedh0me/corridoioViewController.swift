...
class corridoioViewController: FormViewController {
        ...
        form
            ...
            <<< ButtonRow()
                { bottone in
                    ...
                    bottone.presentationMode = .segueName(segueName: segueNamesv2.corridoioToDash, onDismiss: nil)
        }
