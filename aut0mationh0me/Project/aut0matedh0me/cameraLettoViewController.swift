//
//  cameraLettoViewController.swift
//  aut0matedh0me
//
...
class cameraLettoViewController: FormViewController {
...
//        group.enter()
//
//        Alamofire.request(self.URL_REQUEST_NUMBER , method: .get ).responseData
//            { response in
//                print (response)
        ...
        form
            ...
            <<< ButtonRow()
                { bottone in
                    ...
                    bottone.presentationMode = .segueName(segueName: segueNamesv2.cameraLettoToDash, onDismiss: nil)
        }
