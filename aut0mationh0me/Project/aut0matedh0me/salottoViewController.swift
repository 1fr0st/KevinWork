...
class salottoViewController: FormViewController {
        ...
        form
            ...
            <<< ButtonRow()
                { bottone in
                    ...
                    bottone.presentationMode = .segueName(segueName: segueNamesv2.salottoToDash, onDismiss: nil)
        }
