...
class giardinoViewController: FormViewController {
        ...
        form
            ...
            <<< ButtonRow()
                { bottone in
                    ...
                    bottone.presentationMode = .segueName(segueName: segueNamesv2.giardinoToDash, onDismiss: nil)
        }
