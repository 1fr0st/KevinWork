//
//  cameraOspitiViewController.swift
//  aut0matedh0me
//
...
class cameraOspitiViewController: FormViewController {
        ...
        form
            ...
            <<< ButtonRow()
                { bottone in
                    ...
                    bottone.presentationMode = .segueName(segueName: segueNamesv2.cameraOspitiToDash, onDismiss: nil)
        }
